...
export default function SystemPage() {
  ...
  const tabs = [
    { key: 'home', label: 'System Features', icon: '🏠' },
        ...
        <div className="mt-8 mb-6">
          <div className="flex justify-center border-b">
            {tabs.map((tab) => (
              <button
                key={tab.key}
                onClick={() => setActiveTab(tab.key as 'home' | 'blog')}
    ...
    <div className="flex gap-6">
      ...
      <div className="w-2/3">
        ...
        <div className="space-y-3">
          {featureSections[selectedSection as keyof typeof featureSections]?.map((feature) => (
            <div
              key={feature.path}
              className="p-4 bg-blue-50 rounded-lg border border-blue-100 hover:bg-blue-100 transition-colors duration-200"
            >
              <a href={feature.path} className="block text-blue-700 hover:text-blue-800">
...
// Blog Content Component (Embedded Blog List)
