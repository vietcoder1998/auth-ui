...
/**
 * Permission utility class for managing and extracting permissions
 */
export class PermissionUtils {
  // Resource mappings constant
  private static readonly RESOURCE_MAPPINGS: Record<
    string,
   ...
   */
  static extractPermissionFromUrl(url: string, method: string = 'GET'): PermissionInfo | null {
    if (!url) return null;
    ...
    const mapping = resourceSegment ? this.RESOURCE_MAPPINGS[resourceSegment] : null;
   ...
   */
  static getCommonAdminPermissions(id?: string): PermissionInfo[] {
...
export const extractPermissionFromUrl =
  PermissionUtils.extractPermissionFromUrl.bind(PermissionUtils);
export const getCommonAdminPermissions =
  PermissionUtils.getCommonAdminPermissions.bind(PermissionUtils);
